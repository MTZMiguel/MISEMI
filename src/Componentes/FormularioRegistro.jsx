...
function FormularioRegistro() {
    ...
    const peticionGet = () => {
        axios.get('https://backend.miguelitoooo.repl.co/api/Usuarios')
            .then((response) => {
    ...
    const peticionPost = async () => {
        delete form.Id;
        await axios.post('https://backend.miguelitoooo.repl.co/api/Usuarios', form)
            .then(response => {
                alert('Bienvenido');
            })
            .catch(error => {
                    ...
                    <div className="mx-auto" style={{ maxWidth: "500px" }}>
                        <form className="row g-3" noValidate="">
                            <div className="col-12">
                                ...
                                <input type="text" className="form-control" name="Nombre" id="Usuarios" placeholder="Nombres" required="" onChange={handleChange} value={form.Nombre}></input>
                            </div>
                            <div className="col-12">
                                <label htmlFor="inputAddress" className="form-label">
                                    <strong>Apellidos</strong>
                                </label>
                                <input type="text" className="form-control" name="Apellido" id="Usuario" placeholder="Apellido" required="" onChange={handleChange} value={form.Apellido}></input>
                            </div>
